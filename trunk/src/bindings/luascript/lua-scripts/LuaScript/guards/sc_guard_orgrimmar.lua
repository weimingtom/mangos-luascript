...
m_scripts[scriptname]["GossipHello"] = function(player,_Creature)
    ...
    player:ADD_GOSSIP_ITEM( 0, "The wind rider master" , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2)
    ...
    player:ADD_GOSSIP_ITEM( 0, "The Officers Lounge"   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10)
    player:ADD_GOSSIP_ITEM( 0, "The battlemaster"      , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11)
    player:ADD_GOSSIP_ITEM( 0, "A class trainer"       , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12)
    player:ADD_GOSSIP_ITEM( 0, "A profession trainer"  , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13)
