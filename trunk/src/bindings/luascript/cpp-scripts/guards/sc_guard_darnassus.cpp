...
bool GossipHello_guard_darnassus(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( 6, "The Bank"             , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    ...
    player->ADD_GOSSIP_ITEM( 5, "Stable Master"        , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM( 0, "Weapons Trainer"      , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM( 8, "Battlemaster"         , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM( 3, "Class Trainer"        , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM( 3, "Profession Trainer"   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
