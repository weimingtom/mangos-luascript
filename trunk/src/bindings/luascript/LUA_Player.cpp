...
[
	...
	.def("isGMVisibleFor", &Player::isGMVisibleFor)
	...
	/*.def("CanUseItem", &Player::CanUseItem)*/
	...
	/*.def("GetDivider", &Player::GetDivider)/**/
	/*.def("SetDivider", &Player::SetDivider)/**/
	...
	.def("SetDuelVs", &Player::SetDuelVs)
	.def("SetInDuel", &Player::SetInDuel)
	.def("isInDuel", &Player::isInDuel)
	.def("isRequestedOrStartDuel", &Player::isRequestedOrStartDuel)
	.def("SetDuelSender", &Player::SetDuelSender)
