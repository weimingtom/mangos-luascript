...
UPDATE `creature_template` SET`ScriptName` = 'private_alliance' WHERE `entry` = 40100;
UPDATE `creature_template` SET`ScriptName` = 'corporal_alliance' WHERE `entry` = 40101;
UPDATE `creature_template` SET`ScriptName` = 'sergeant_alliance' WHERE `entry` = 40102;
UPDATE `creature_template` SET`ScriptName` = 'master_sergeant_alliance' WHERE `entry` = 40103;
UPDATE `creature_template` SET`ScriptName` = 'sergeant_major_alliance' WHERE `entry` = 40104;
UPDATE `creature_template` SET`ScriptName` = 'knight_alliance' WHERE `entry` = 40105;
UPDATE `creature_template` SET`ScriptName` = 'knight_lieutenant_alliance' WHERE `entry` = 40106;
UPDATE `creature_template` SET`ScriptName` = 'knight_captain_alliance' WHERE `entry` = 40107;
UPDATE `creature_template` SET`ScriptName` = 'knight_champion_alliance' WHERE `entry` = 40108;
UPDATE `creature_template` SET`ScriptName` = 'lieutenant_commander_alliance' WHERE `entry` = 40109;
UPDATE `creature_template` SET`ScriptName` = 'commander_alliance' WHERE `entry` = 40110;
UPDATE `creature_template` SET`ScriptName` = 'marshal_alliance' WHERE `entry` = 40111;
UPDATE `creature_template` SET`ScriptName` = 'field_marshal_alliance' WHERE `entry` = 40112;
UPDATE `creature_template` SET`ScriptName` = 'grand_marshal_alliance' WHERE `entry` = 40113;
UPDATE `creature_template` SET`ScriptName` = 'scout_horde' WHERE `entry` = 40200;
UPDATE `creature_template` SET`ScriptName` = 'grunt_horde' WHERE `entry` = 40201;
UPDATE `creature_template` SET`ScriptName` = 'sergeant_horde' WHERE `entry` = 40202;
UPDATE `creature_template` SET`ScriptName` = 'senior_sergeant_horde' WHERE `entry` = 40203;
UPDATE `creature_template` SET`ScriptName` = 'first_sergeant_horde' WHERE `entry` = 40204;
UPDATE `creature_template` SET`ScriptName` = 'stone_guard_horde' WHERE `entry` = 40205;
UPDATE `creature_template` SET`ScriptName` = 'blood_guard_horde' WHERE `entry` = 40206;
UPDATE `creature_template` SET`ScriptName` = 'legionnaire_horde' WHERE `entry` = 40207;
UPDATE `creature_template` SET`ScriptName` = 'centurion_horde' WHERE `entry` = 40208;
UPDATE `creature_template` SET`ScriptName` = 'champion_horde' WHERE `entry` = 40209;
UPDATE `creature_template` SET`ScriptName` = 'lieutenant_general_horde' WHERE `entry` = 40210;
UPDATE `creature_template` SET`ScriptName` = 'general_horde' WHERE `entry` = 40211;
UPDATE `creature_template` SET`ScriptName` = 'warlord_horde' WHERE `entry` = 40212;
UPDATE `creature_template` SET`ScriptName` = 'high_warlord_horde' WHERE `entry` = 40213;
