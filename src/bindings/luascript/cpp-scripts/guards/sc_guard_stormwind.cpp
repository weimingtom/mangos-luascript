...
{
    player->ADD_GOSSIP_ITEM( 1, "Auction House"		   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);  //added
    player->ADD_GOSSIP_ITEM( 6, "Bank of Stormwind"    , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    player->ADD_GOSSIP_ITEM( 0, "Deeprun Tram"		   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);  //added
    player->ADD_GOSSIP_ITEM( 1, "The Inn"              , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
    player->ADD_GOSSIP_ITEM( 2, "Gryphon Master"       , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);    
    player->ADD_GOSSIP_ITEM( 0, "Guild Master"         , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM( 4, "Mailbox"              , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);  //added
    player->ADD_GOSSIP_ITEM( 5, "Stable Master"        , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM( 0, "Weapon Trainer"       , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);  //added
    player->ADD_GOSSIP_ITEM( 0, "Officers` Lounge"     , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM( 8, "Battlemaster"         , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11); //added
...
void SendDefaultMenu_guard_stormwind(Player *player, Creature *_Creature, uint32 action)
{
    ...
    if (action == GOSSIP_ACTION_INFO_DEF + 12)//Class trainers
    {
        ...
        player->ADD_GOSSIP_ITEM( 3, "Hunter"               , GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 7);        
        player->ADD_GOSSIP_ITEM( 3, "Warlock"              , GOSSIP_SENDER_SEC_CLASSTRAIN, GOSSIP_ACTION_INFO_DEF + 8);
